...
QT_MOC_LITERAL(1, 11, 14), // "sendTranslateZ"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 5), // "value"
QT_MOC_LITERAL(4, 33, 16) // "receiveRotationZ"

    },
    "MyGLWidget\0sendTranslateZ\0\0value\0"
    "receiveRotationZ"
};
...
void MyGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendTranslateZ((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->receiveRotationZ((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGLWidget::sendTranslateZ)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyGLWidget::sendTranslateZ(int _t1)
{
